...
from .models import SourceDocument, OrgUnit, DataElement, DataValue, Category, CategoryCombo, ValidationRule, load_excel_to_datavalues, load_excel_to_validations, quarterly_reports
...
admin.site.register(quarterly_reports)
