...
urlpatterns = [
    ...
    url(r'validation_report\.php', views.validation_report, name='validation_report'),
    url(r'validation_report\.xls', views.validation_report, {'output_format': 'EXCEL'}, name='validation_report_excel'),
